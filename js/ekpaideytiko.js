...
"a3": "3. Ο άνθρακας μπορεί να προσροφήσει επιλεκτικά μεγάλες ποσότητες τοξινών-δηλητηρίων κ.λ.π",\
"a4":"4. Απεβίωσε μετά από 1 μήνα",\
"true":"3. Ο άνθρακας μπορεί να προσροφήσει επιλεκτικά μεγάλες ποσότητες τοξινών-δηλητηρίων κ.λ.π"},\
\
...
"a1":"1. Αυξάνουν την ποσότητα του ήλιου στο περιβάλλον",\
...
"a4":"4. Για την καινοτόμο έρευνα στην εξόρυξη πετρελαίου",\
...
"a2":"2. Goody’s-Mc Donald’s-KFC-Wendy’s ",\
"a3": "3. Zara-Gucci-Versace-Yve Saint Laurent ",\
"a4":"4. Porsche-BMV-Mercedes-Saab",\
